...
const Canvas = () => {
    ...
    return (
        <div className={classes.Canvas}>
            ...
            <p>Source code: <a href="https://gitlab.com/lixiao.shanghai/color">GitLab</a></p>
            <p>GitLab CI/CD Pipeline config YAML file: <a href="https://gitlab.com/lixiao.shanghai/color/-/blob/main/.gitlab-ci.yml">Pipeline</a></p>
            <ReactCountdownClock/>
        </div>
    )
}
